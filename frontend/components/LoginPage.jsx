...
function LoginPage({ data }) {
  ...
  const [renderedContent, setRenderedContent] = useState(<div className='flex items-center align-center justify-center'><img src='/images/blob.gif' width={900} height={900} /></div>);
  ...
  return (
    <Layout>
      <div className='w-full flex flex-row'>
        ...
        <div className=' w-1/3 flex flex-col overflow-x-hidden'>
          ...
          <div>
            <SpeechChatbot setContent={handleContent} />
          </div>
